...
TEXTO : VARIABLE PR_CONCATENAR TEXTO | TEXTO PR_CONCATENAR VARIABLE | TEXTO PR_CONCATENAR TEXTO | ('\"')VALOR('\"') | VARIABLE;
...
OPERADOR_MATEMATICO : '+'|'-'|'*'|'/';
OPERADOR_LOGICO : 'mayor que' | 'menor que' | 'mayor o igual que' | 'menor o igual que' | 'igual' | 'diferente' | 'y' | 'o' | 'no' |
